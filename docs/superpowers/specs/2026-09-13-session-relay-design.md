...
(`2eac95`) and its bound repository (`skomp/tutorail-bundles`). Names alone are not
enough: in the observed fleet, `tutorail-8c` and `tutorial-run` cannot be told
...
{ "name": "bundles", "ref": "2eac95", "repo": "skomp/tutorail-bundles",
  "cwd": "/Users/robert/src/github.com/skomp/tutorail-bundles",
